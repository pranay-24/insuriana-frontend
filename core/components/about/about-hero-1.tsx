...
export function AboutHero1() {
  return (
      ...
      <Section style={{background:"#dbdee0"}}>
      <Container >
        ...
        <div className="flex flex-col  gap-12 items-center">
          ...
          <div className="relative h-[400px] md:h-[500px] w-full lg:w-auto lg:aspect-square rounded-xl overflow-hidden shadow-lg order-1 lg:order-2">
            <Image
              alt="Hero product"
